...
class ProductPriceCustomCreate extends PolarData
{
    public function __construct(
         ...
         * want' and $0 is accepted. If set to a value below the minimum price amount for the currency,
         * it will be rejected. Defaults to the minimum price amount for the currency. Minimum per
         * currency:
         * - USD: 0.5
         * - AED: 2
         * - ALL: 50
        ...
        /**
         * The initial amount shown to the customer. If 0, the customer will see $0 as the default. If
         * set to a value below the minimum price amount for the currency, it will be rejected.Minimum
         * per currency:
         * - USD: 0.5
         * - AED: 2
         * - ALL: 50
         ...
         * - Other currencies: 50 minor units
         */
        public readonly ?int $presetAmount = null,
    ) {}
}
